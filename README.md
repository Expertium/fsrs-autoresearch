# fsrs-autoresearch
Improving FSRS-7 with Claude. Huge thanks to [1DWalker](https://github.com/1DWalker), without [his code](https://github.com/open-spaced-repetition/fsrs-gpu-benchmark) this wouldn't be possible!
