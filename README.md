...
5) There are 2 times when log loss went up: when a cheating improvement was removed, and when I changed how the number of epochs and batch size are chosen.
